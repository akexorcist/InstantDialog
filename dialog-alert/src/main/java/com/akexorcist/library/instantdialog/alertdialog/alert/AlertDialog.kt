...
import com.akexorcist.library.instantdialog.alertdialog.R

class AlertDialog : CoreDialogFragment<AlertDialogViewModel>(),
    LayoutOption,
    TitleOption,
    MessageOption,
    NeutralButtonOption,
    ...
    override fun bindViewModel() = AlertDialogViewModel::class.java
    ...
    override fun bindView(parent: View) {
        ...
        neutralButton.setOnClickListener {
            viewModel.onNeutralButtonClick(tag, bundle, this)
        }
    }
