...
class ConfirmDialog : CoreDialogFragment<ConfirmViewModel>(),
    LayoutOption,
    TitleOption,
    MessageOption,
    ...
    override fun bindViewModel() = ConfirmViewModel::class.java
    ...
    override fun bindView(parent: View) {
        ...
        positiveButton.setOnClickListener {
            viewModel.onPositiveButtonClick(tag, bundle)
            dismiss()
        }
        negativeButton.setOnClickListener {
            viewModel.onNegativeButtonClick(tag, bundle)
            dismiss()
        }
    }
